                    ...
                    <div class="row d-flex align-items-stretch">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_post_title" value="{{ old('title') }}" name="title" type="text" class="form-control @error('title')
                                        is-invalid
                                    @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_post_slug" value="{{ old('slug') }}" name="slug" type="text" class="form-control  @error('slug')
                                    is-invalid
                                @enderror" placeholder="{{ trans('posts.form_control.input.slug.placeholder') }}"
                                    readonly />
                                @error('slug')
                                <span class="invalid-feedback">
                                    <strong>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="input_post_thumbnail" name="thumbnail" value="{{ old('thumbnail') }}"
                                        type="text" class="form-control @error('thumbnail')
                                            is-invalid
                                        @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="input_post_description" name="description"
                                    ...
                                    class="form-control @error('description')
                                        is-invalid
                                    @enderror" rows="3">{{ old('description') }}</textarea>
                                @error('description')
                                <span class="invalid-feedback">
                                    <strong>
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="input_post_content" name="content"
                                    placeholder="{{ trans('posts.form_control.textarea.content.placeholder') }}" class="form-control @error('content')
                                        is-invalid
                                    @enderror" rows="20">{{ old('content') }}</textarea>
                                @error('content')
                                <span class="invalid-feedback">
                                    <strong>
                                        {{ $message }}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select id="select_post_tag" name="tag[]"
                                    data-placeholder="{{ trans('posts.form_control.select.tag.placeholder') }}" class="custom-select w-100 @error('tag')
                                        is-invalid
                                    @enderror" multiple>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="float-right">
                                <a class="btn btn-warning px-4" href=""> {{ trans('posts.button.back.value') }}</a>

...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            if ($request['tag']) {
                $request['tag'] = Tag::select('id', 'title')
    ...
    private function statuses()
    {
        return [
            ...
            'publish' => trans(
                'posts.form_control.select.status.option.publish'
            ),
        ];
    }
    private function attributes()
    {
        return [
            ...
            'thumbnail' => trans(
                'posts.form_control.input.thumbnail.attribute'
            ),
            'description' => trans(
                'posts.form_control.textarea.description.attribute'
            ),
